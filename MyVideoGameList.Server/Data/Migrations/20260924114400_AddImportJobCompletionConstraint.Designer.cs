...
namespace MyVideoGameList.Server.Data.Migrations
{
    ...
    [Migration("20260924114400_AddImportJobCompletionConstraint")]
    partial class AddImportJobCompletionConstraint
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyVideoGameList.Server.Models.CachedGame", b =>
                {
                    ...
                    b.ToTable("CachedGames");
                });

            modelBuilder.Entity("MyVideoGameList.Server.Models.ImportJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MyVideoGameList.Server.Models.ImportRow", b =>
                {
                    ...
                    b.HasIndex("ImportJobId", "Title");

                    b.HasIndex("ImportJobId", "UserId");
            ...
            modelBuilder.Entity("MyVideoGameList.Server.Models.PlaythroughType", b =>
                {
                    b.Property<short>("Id")
                        .HasColumnType("smallint");
            ...
            modelBuilder.Entity("MyVideoGameList.Server.Models.UserGamePlaythrough", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("UserId", "UserGameEntryId");

                    b.ToTable("UserGamePlaythroughs", t =>
                        {
                            t.HasCheckConstraint("CK_UserGamePlaythroughs_Dates_Order", "\"StartedOn\" IS NULL OR \"FinishedOn\" IS NULL OR \"FinishedOn\" >= \"StartedOn\"");

                            t.HasCheckConstraint("CK_UserGamePlaythroughs_MinutesPlayed_Range", "\"MinutesPlayed\" IS NULL OR (\"MinutesPlayed\" >= 1 AND \"MinutesPlayed\" <= 600000)");
                        });
                });
            ...
            modelBuilder.Entity("MyVideoGameList.Server.Models.ImportRow", b =>
                {
                    ...
                    b.HasOne("MyVideoGameList.Server.Models.ImportJob", "Job")
                        .WithMany()
                        .HasForeignKey("ImportJobId", "UserId")
            ...
            modelBuilder.Entity("MyVideoGameList.Server.Models.UserGamePlaythrough", b =>
                {
                    b.HasOne("MyVideoGameList.Server.Models.PlaythroughType", "Type")
                        .WithMany()
