...
| H6 | **Stats strip** — finished this year, hours logged, current streak | Partly unblocked: finishes and the streak now come from `/api/user/stats`. Hours still need Tier 1 per-entry tracking |
